...
/**
 * The real production type the user-vocabulary repository is written against — see
 ...
 */
export type VocabularyDb = NodePgDatabase<typeof schema>;

export interface VocabularyDbHandle {
  db: VocabularyDb;
  close: () => Promise<void>;
}
