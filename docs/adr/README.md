...
| [012](adr-012-video-generation.md)         | Video generation (Hyperframes)                                                           | ACCEPTED (architecture + fake provider) / real HyperframesCliProvider implemented-unverified                                   |
| [013](adr-013-audio-generation.md)         | Audio generation (Gemini)                                                                | ACCEPTED (architecture + fake provider) / GeminiAudioProvider implemented-unverified / production use PENDING (provider terms) |
...
| [018](adr-018-content-languages.md)        | Languages, CEFR levels & content data                                                    | ACCEPTED                                                                                                                       |
| [019](adr-019-lessons.md)                  | Lessons: content in files, progress per student                                          | ACCEPTED                                                                                                                       |
| [020](adr-020-exercises.md)                | Exercises: content in files, per-type evaluators, append-only attempts                   | ACCEPTED                                                                                                                       |
| [021](adr-021-gamification.md)             | Gamification: append-only points ledger, idempotent rewards, achievement rules           | ACCEPTED                                                                                                                       |
| [022](adr-022-vocabulary.md)               | Vocabulary: entries as content grouped by category, status as per-student state          | ACCEPTED                                                                                                                       |
| [023](adr-023-phonetics.md)                | Phonetics: representations as content optionally grouped by topic, forward-only progress | ACCEPTED                                                                                                                       |
